...
public final class FreeEnchantmentBonus implements SkillBonus<FreeEnchantmentBonus> {
   ...
   public FreeEnchantmentBonus copy() {
      FreeEnchantmentBonus bonus = new FreeEnchantmentBonus(this.chance);
   ...
   public MutableComponent getTooltip() {
      ...
      if (this.chance < 1.0F) {
         ...
         tooltip = Component.translatable(this.getDescriptionId(), new Object[]{this.itemStackPredicate.getTooltip("plural")});
      }
