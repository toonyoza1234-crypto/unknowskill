...
public final class DamageTakenBonus implements SkillBonus<DamageTakenBonus> {
   ...
   public DamageTakenBonus(float amount, Operation operation) {
      this.amount = amount;
      this.operation = operation;
   }

   public float getDamageBonus(Operation operation, DamageSource source, Player player, LivingEntity attacker) {
      if (this.operation != operation) {
         ...
         return !this.attackerCondition.test(attacker)
            ? 0.0F
            : this.amount * this.playerMultiplier.getValue(player) * this.attackerMultiplier.getValue(attacker);
      }
   }
   ...
   public boolean canMerge(SkillBonus<?> other) {
      if (other instanceof DamageTakenBonus otherBonus) {
         if (!Objects.equals(otherBonus.playerMultiplier, this.playerMultiplier)) {
            ...
            return !Objects.equals(otherBonus.attackerCondition, this.attackerCondition) ? false : otherBonus.operation == this.operation;
         }
      } else {
         return false;
      }
   ...
   public MutableComponent getTooltip() {
      ...
      tooltip = TooltipHelper.getSkillBonusTooltip(tooltip, (double)this.amount, this.operation);
   ...
   private void selectOperation(Consumer<DamageTakenBonus> consumer, Operation operation) {
   ...
   public static class Serializer implements SkillBonus.Serializer {
      ...
      public SkillBonus<?> createDefaultInstance() {
         return new DamageTakenBonus(0.1F, Operation.MULTIPLY_BASE).setDamageCondition(new MeleeDamageCondition());
      }
   }
}
