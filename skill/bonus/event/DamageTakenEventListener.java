...
public class DamageTakenEventListener implements SkillEventListener {
   ...
   public MutableComponent getTooltip(Component bonusTooltip) {
      Component damageDescription = this.damageCondition.getTooltip();
      MutableComponent eventTooltip = Component.translatable(this.getDescriptionId(), new Object[]{bonusTooltip, damageDescription});
