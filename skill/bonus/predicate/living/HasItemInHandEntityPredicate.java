...
public final class HasItemInHandEntityPredicate implements LivingEntityPredicate {
   ...
   public boolean test(LivingEntity living) {
      return this.itemStackPredicate.test(living.getMainHandItem()) || this.itemStackPredicate.test(living.getOffhandItem());
   }
   ...
   public LivingEntityPredicate.Serializer getSerializer() {
      return (LivingEntityPredicate.Serializer)PSTLivingConditions.HAS_ITEM_IN_HAND.get();
   }
