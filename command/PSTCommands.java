...
public class PSTCommands {
   ...
   public static void registerCommands(RegisterCommandsEvent event) {
      LiteralArgumentBuilder<CommandSourceStack> resetCommand = (LiteralArgumentBuilder<CommandSourceStack>)((LiteralArgumentBuilder)Commands.literal(
               "skilltree"
            )
            .then(Commands.literal("reset").then(Commands.argument("player", EntityArgument.player()).executes(PSTCommands::executeResetCommand))))
         .requires(PSTCommands::hasPermission);
      event.getDispatcher().register(resetCommand);
      LiteralArgumentBuilder<CommandSourceStack> addPointsCommand = (LiteralArgumentBuilder<CommandSourceStack>)((LiteralArgumentBuilder)Commands.literal(
               "skilltree"
            )
            .then(
      ...
      LiteralArgumentBuilder<CommandSourceStack> setPointsCommand = (LiteralArgumentBuilder<CommandSourceStack>)((LiteralArgumentBuilder)Commands.literal(
               "skilltree"
            )
            .then(
               Commands.literal("points")
